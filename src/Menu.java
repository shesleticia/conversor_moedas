public class Menu {
    ...
    public void exibirMenu() {
        ...
        System.out.println("9. BRL (Real) para ETH (Usdt)");
        System.out.println("10. ETH (Usdt) para BRL (Real)");
    ...
    public void processarOpcao(int opcao) {
        switch (opcao) {
            ...
            case 8:
                ...
                break;
            case 9:
                conversor.converterMoeda("BRL", "ETH");
                break;
            case 10:
                conversor.converterMoeda("ATH", "BRL");
                break;
            default:
